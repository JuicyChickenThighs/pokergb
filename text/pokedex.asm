...
_NidoranMDexEntry::
	...
	next "when it is listening"

	page "to distant sounds."
	next "It extends toxic"
	next "barbs when angered"
	dex

_ClefairyDexEntry::
	text "Its adorable"
	next "appearance makes it"
	next "a popular pet."
...
_SpearowDexEntry::
	text "It buisily flies"
	next "around here and there."
	next "Even if it is frail,"

	page "it can be a tough"
	next "foe who uses"
	next "MIRROR MOVE"
	dex
...
_IvysaurDexEntry::
	...
	next "is said to grow into"
	next "a large flower"
	dex

_ExeggutorDexEntry::
	text "It is called the"
	next "Walking Rainforest."
	next "Each of the nuts"

	page "on its face has"
	next "a face and a will"
	next "of its own"
	dex
